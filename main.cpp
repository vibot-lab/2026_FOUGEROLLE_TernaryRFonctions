...
void PrintInteractiveControls(ApplicationMode mode)
{
    ...
    if (mode == ApplicationMode::FIELD_RENDER) {
        std::cout
            ...
            << "  7: Algebraic aperture / experimental\n"
...
int main(int argc, char** argv) {
    try {
        ...
        const char* argv0 = "CAD_JUNCTION_RENDER";
        const char* argv1 = "C:\\Development-C++\\2026_CAD_FOUGEROLLE_TernaryRFonctions_code-jrodriguez-Adding_config_file\\config.yaml";
